...
# --- Configuration ---
RAW_DATASET_ROOT = Path('/content/drive/MyDrive/daisee_dataset/DAiSEE')
PROCESSED_DATA_ROOT = Path('/content/drive/MyDrive/daisee_benchmark/data/processed')
...
def main():
    ...
    for split in ['Train', 'Test', 'Validation']:
        ...
        if not split_video_dir.exists(): continue
        ...
        for video_path in tqdm(video_paths, desc=f"Processing {split} videos"):
            ...
            output_audio_path = PROCESSED_DATA_ROOT / split / 'audio' / f"{clip_id}.wav"
