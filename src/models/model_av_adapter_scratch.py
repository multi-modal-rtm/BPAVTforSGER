...
class AVAdapterScratch(nn.Module):
    def __init__(self, video_dim=2048, audio_dim=768, hidden_dim=512, adapter_dim=128, num_classes=2, dropout=0.3):
        super(AVAdapterScratch, self).__init__()
