...
from .architectures.glancefocus import GlanceFocusNet
...
def create_model(config):
    ...
    if model_name in ["ViT", "Swin", "MViT", "Uniformer", "MaxViT"]:
    ...
    elif model_name == "GlanceFocusNet":
        model = GlanceFocusNet(num_classes=config.num_classes)
        logger.info(f"Created standalone {model_name} model (backbones are frozen internally).")
